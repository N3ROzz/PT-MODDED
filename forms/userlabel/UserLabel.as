package forms.userlabel
{
   ...
   public class UserLabel extends Sprite
   {
      ...
      private function setEvent() : void
      {
         ...
         this._userInfoUpdater.addEventListener(UserInfoLabelUpdaterEvent.CHANGE_CLAN_TAG,this.onChangeUid);
      ...
      private function removeEvent() : void
      {
         ...
         this._userInfoUpdater.removeEventListener(UserInfoLabelUpdaterEvent.CHANGE_CLAN_TAG,this.onChangeUid);
