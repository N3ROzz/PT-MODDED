package scpacker.networking.protocol
{
   ...
   import scpacker.networking.protocol.packets.userproperties.UpdateCrystalsInPacket;
   ...
   import scpacker.networking.protocol.packets.userproperties.UpdateUserRatingInPacket;
   import scpacker.networking.protocol.packets.premium.InitPremiumNotifierInPacket;
   import scpacker.networking.protocol.packets.premium.PremiumPacketHandler;
   import scpacker.networking.protocol.packets.premium.UpdatePremiumTimeLeftInPacket;
   ...
   public class PacketInitializer
   {
      ...
      public function init(param1:OSGi) : void
      {
         ...
         // UserProperties live update packets
         packetInvoker.registerPacketHandler(new UserPropertiesPacketHandler());
         packetRegistry.registerPacket(new UpdateCrystalsInPacket());
         packetRegistry.registerPacket(new UpdateRankInPacket());
         packetRegistry.registerPacket(new UpdateScoreInPacket());
         packetRegistry.registerPacket(new UpdateUserRatingInPacket());

         // Premium Packets
         packetInvoker.registerPacketHandler(new PremiumPacketHandler());
         packetRegistry.registerPacket(new InitPremiumNotifierInPacket());
         packetRegistry.registerPacket(new UpdatePremiumTimeLeftInPacket());
         ...
         packetRegistry.registerPacket(new ClanUserInfoInPacket());
