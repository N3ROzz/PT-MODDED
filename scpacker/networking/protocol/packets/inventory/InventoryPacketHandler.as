package scpacker.networking.protocol.packets.inventory
{
   ...
   public class InventoryPacketHandler extends AbstractPacketHandler
   {
      ...
      private function handleInventoryItemActivated(param1:InventoryItemActivatedInPacket) : void
      {
         ...
         if(param1 == null || this.inventoryItemModel == null || BattlePacketHandler.battlefieldGameObject == null || BattlePacketHandler.battlefieldGameObject.space == null)
         {
            return;
         }
         _loc2_ = BattlePacketHandler.battlefieldGameObject.space.getObjectByName(param1.itemId);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         try
         {
            this.inventoryItemModel.activated(param1.clientTime,param1.decrease);
         }
         finally
         {
            Model.popObject();
