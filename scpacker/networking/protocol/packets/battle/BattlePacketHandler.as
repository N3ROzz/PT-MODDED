package scpacker.networking.protocol.packets.battle
{
   ...
   public class BattlePacketHandler extends AbstractPacketHandler
   {
      ...
      private var lastWeaponSfxSelectedKey:String = "";
      ...
      private function initBattle(param1:InitBattleInPacket) : void
      {
         ...
         battlefieldModelCC.proBattle = this.getBoolean(jsonObject,"proBattle",false);
      ...
      private function createTank(param1:CreateTankInPacket) : void
      {
         ...
         var sfxDataJsonObject:Object = this.getWeaponSfxData(JSON.parse(jsonObject.sfxData),jsonObject.turret_id);
         this.logTwinsSfxData(jsonObject.turret_id,this.lastWeaponSfxSelectedKey,sfxDataJsonObject);
      ...
      {
         if(this.turretGameClassDictionary[turretId] == null)
         {
            ...
            this.turretGameClassDictionary[turretId] = gameTypeRegistry.createClass(IdTool.getNextId(),turretGameClassVector);
         }
         return this.turretGameClassDictionary[turretId];
      }

      private function getWeaponSfxData(sfxData:Object, turretId:String) : Object
      {
         var selectedData:Object = null;
         var weaponName:String = turretId.split("_")[0];
         this.lastWeaponSfxSelectedKey = "null";
         if(sfxData == null)
         {
            return null;
         }
         if(sfxData.hasOwnProperty(turretId) && sfxData[turretId] != null)
         {
            this.lastWeaponSfxSelectedKey = turretId;
            selectedData = this.copySfxData(sfxData[turretId]);
            this.applyShaftM2M3SfxOverride(turretId,selectedData);
            return selectedData;
         }
         if(sfxData.hasOwnProperty(weaponName) && sfxData[weaponName] != null)
         {
            this.lastWeaponSfxSelectedKey = weaponName;
            selectedData = this.copySfxData(sfxData[weaponName]);
            this.applyShaftM2M3SfxOverride(turretId,selectedData);
            return selectedData;
         }
         this.lastWeaponSfxSelectedKey = "raw_sfx_data";
         selectedData = this.copySfxData(sfxData);
         this.applyShaftM2M3SfxOverride(turretId,selectedData);
         return selectedData;
      }

      private function logTwinsSfxData(turretId:String, selectedKey:String, selectedData:Object) : void
      {
         var bcshKeys:String = null;
         var bcshEntry:Object = null;
         if(turretId == null || turretId.split("_")[0] != "twins")
         {
            return;
         }
         ...
         bcshKeys = "";
         if(selectedData.bcsh != null)
         {
            for each(bcshEntry in selectedData.bcsh)
            {
               if(bcshKeys.length > 0)
               {
                  bcshKeys += ",";
               }
      ...
      private function applyShaftM2M3SfxOverride(turretId:String, selectedData:Object) : void
      {
         if(selectedData == null)
         {
            return;
         }
         if(turretId == "shaft_m2")
         {
            this.applyShaftM2Bcsh(selectedData);
         }
      }

      private function applyShaftM2Bcsh(selectedData:Object) : void
      {
         if(selectedData.bcsh == null)
         {
            selectedData.bcsh = [];
         }
         this.addShaftBcsh(selectedData.bcsh,"shaft");
         this.addShaftBcsh(selectedData.bcsh,"shaft_m2");
         this.addShaftBcsh(selectedData.bcsh,"explosion");
         this.addShaftBcsh(selectedData.bcsh,"muzzleFlash");
      }

      private function addShaftBcsh(bcsh:Object, key:String) : void
      {
         bcsh.push({
            "key":key,
            "brightness":14.668,
      ...
      {
         var _loc2_:Long = LongUtils.strToId(param1.bonusId);
      ...
      private function getBoolean(param1:Object, param2:String, param3:Boolean) : Boolean
      {
         if(param1 != null && param1.hasOwnProperty(param2) && param1[param2] != null)
         {
