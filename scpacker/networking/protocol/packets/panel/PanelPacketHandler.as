package scpacker.networking.protocol.packets.panel
{
   ...
   public class PanelPacketHandler extends AbstractPacketHandler
   {
      ...
      private var accountStatsLoaded:Boolean = false;
      ...
      private function updateAccountStats(param1:LoadAccountStatsInPacket) : void
      {
         ...
         this.userPropertiesModel.updateGearScore(param1.userPropertyCC.gearScore);
         this.userPropertiesModel.updateUserRating(param1.userPropertyCC.userRating,param1.userPropertyCC.place);
         if(param1.userPropertyCC.rankBounds != null)
         {
            this.userPropertiesModel.updateRank(param1.userPropertyCC.rank,param1.userPropertyCC.score,param1.userPropertyCC.rankBounds,0,param1.userPropertyCC.canUseGroup,true,true);
         }
      }
