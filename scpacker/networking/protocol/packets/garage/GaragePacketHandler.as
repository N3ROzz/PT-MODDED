   ...
   public class GaragePacketHandler extends AbstractPacketHandler
   {
      ...
      private function loadPurchasableItems(packet:LoadPurchasableItemsInPacket) : void
      {
         ...
         for each(var processingEntry:Object in processingItems)
         {
            ...
            {
               PaintRegistry.addPaint(item.name,int(item.coloring));
               if(PaintRegistry.isSpecialPaintName(item.name))
               {
                  PaintRegistry.markVisualOnlyItem(gameObject);
               }
            }
      ...
      private function resolveKitComponent(param1:Object, param2:Object, param3:Object, param4:Object) : Object
      {
         ...
         _loc6_ = this.garageSpace.getObjectByName(_loc5_);
         if(_loc6_ != null)
         {
            return {item:_loc6_,source:"garage_space_object_name",reason:"resolved"};
         }
