package juho.hacking.hacks {
   ...
   public class AimHack extends Hack {
      ...
      private function applyState():void {
         SmokyWeapon.cheatTargetingEnabled = this.isEnabled;
         TwinsWeapon.cheatTargetingEnabled = this.isEnabled;
         RailgunWeapon.cheatTargetingEnabled = this.isEnabled;
         ThunderWeapon.cheatTargetingEnabled = this.isEnabled;
         this.setMaxLeftAngleState();
         this.setMaxRightAngleState();
         this.setMaxUpAngleState();
         this.setMaxDownAngleState();
         this.setDebugState();
      }
