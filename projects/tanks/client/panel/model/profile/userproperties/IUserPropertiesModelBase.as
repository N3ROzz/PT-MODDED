package projects.tanks.client.panel.model.profile.userproperties
{
   ...
   public interface IUserPropertiesModelBase
   {
      ...
      function updateRank(param1:int, param2:int, param3:RankBounds, param4:int, param5:Boolean, param6:Boolean, param7:Boolean = false) : void;
      
      function updateScore(param1:int, param2:Boolean = false) : void;
      
      function updateUid(param1:String) : void;
      
      function updateUserRating(param1:Number, param2:int = -1) : void;
   }
}
