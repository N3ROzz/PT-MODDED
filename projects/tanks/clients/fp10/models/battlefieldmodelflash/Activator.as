...
{   
   ...
   public class Activator implements IBundleActivator
   {
      ...
      public function start(param1:OSGi) : void
      {
         ...
         {
            StatisticsDmModel.moneyService = IMoneyService(param1);
         },function():IMoneyService
         {
            return StatisticsDmModel.moneyService;
         });
         osgi.injectService(INotificationService,function(param1:Object):void
         {
         ...
         osgi.injectService(IMoneyService,function(param1:Object):void
         {
            StatisticsTeamModel.moneyService = IMoneyService(param1);
         },function():IMoneyService
         {
            return StatisticsTeamModel.moneyService;
         });
         osgi.injectService(INotificationService,function(param1:Object):void
         {
