package projects.tanks.clients.fp10.libraries.tanksservicesflash
{
   ...
   public class Activator implements IBundleActivator
   {
      ...
      public function start(param1:OSGi) : void
      {
         ...
         {
            UserNotifierModel.userPropertiesService = IUserPropertiesService(param1);
         },function():IUserPropertiesService
         {
            return UserNotifierModel.userPropertiesService;
         });
         ...
         modelRegister.add(new FriendsOutgoingModel());
