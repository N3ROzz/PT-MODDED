package projects.tanks.clients.fp10.libraries.tanksservices.service.user
{
   ...
   public class UserInfoLabelUpdaterEvent extends Event
   {
      ...
      public static const CHANGE_CLAN_TAG:String = "UserLabelUpdaterEvent.CHANGE_CLAN_TAG";
      
      public var userId:String;
      
      public function UserInfoLabelUpdaterEvent(param1:String, param2:Boolean = false, param3:Boolean = false, param4:String = null)
      {
