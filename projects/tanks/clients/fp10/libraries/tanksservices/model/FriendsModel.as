   ...
   public class FriendsModel extends FriendsModelBase implements IFriendsModelBase, ObjectLoadListener, ObjectUnloadListener, IFriends
   {
      ...
      public function objectLoaded() : void
      {
         if(IFriends(object.adapt(IFriends)).isLocal())
         {
            ...
            friendsActionService.addEventListener(FriendActionServiceUidEvent.CHECK,getFunctionWrapper(this.onCheckUid));
            ...
            friendsActionService.addEventListener(FriendActionServiceEvent.REVOKE,getFunctionWrapper(this.onRevoke));
         }
      }
      ...
      public function objectUnloaded() : void
      {
         if(IFriends(object.adapt(IFriends)).isLocal())
         {
            ...
            friendsActionService.removeEventListener(FriendActionServiceUidEvent.CHECK,getFunctionWrapper(this.onCheckUid));
            ...
            friendsActionService.removeEventListener(FriendActionServiceEvent.REVOKE,getFunctionWrapper(this.onRevoke));
         }
      }
