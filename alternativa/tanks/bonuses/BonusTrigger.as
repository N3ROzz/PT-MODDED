package alternativa.tanks.bonuses
{
   ...
   public class BonusTrigger extends BattleRunnerProvider implements Trigger
   {
      ...
      private var diagnosticsEnabledState:Boolean;

      private var diagnosticsWasEnabled:Boolean;
      ...
      public function enable() : void
      {
         ...
         if(!this.diagnosticsEnabledState)
         {
            GoldBoxDiagnostics.triggerEnabled(GoldBoxDiagnostics.canonicalFromLong(this.bonus.bonusId),this.diagnosticsWasEnabled);
            this.diagnosticsEnabledState = true;
            this.diagnosticsWasEnabled = true;
         }
      }

      public function resetDiagnosticsState() : void
      {
         this.diagnosticsEnabledState = false;
         this.diagnosticsWasEnabled = false;
      }
      ...
      public function disable() : void
      {
         ...
         {
            this.diagnosticsEnabledState = false;
            GoldBoxDiagnostics.triggerDisabled(GoldBoxDiagnostics.canonicalFromLong(this.bonus.bonusId));
         }
      }
      ...
      public function checkTrigger(param1:Body) : void
      {
         ...
         while(_loc2_ < param1.numCollisionShapes)
         {
            ...
            {
               GoldBoxDiagnostics.triggerActivated(GoldBoxDiagnostics.canonicalFromLong(this.bonus.bonusId));
