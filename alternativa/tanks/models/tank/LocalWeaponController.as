package alternativa.tanks.models.tank
{
   ...
   public class LocalWeaponController extends BattleRunnerProvider implements IWeaponController
   {
      ...
      {
         if(this.lockMask.isEmpty() && this.weapon is LocalWeapon)
         {
            LocalWeapon(this.weapon).pullTrigger();
         }
      }

      public function releaseTrigger() : void
      {
         if(this.weapon is LocalWeapon)
         {
            LocalWeapon(this.weapon).releaseTrigger();
         }
      }
   }
}
