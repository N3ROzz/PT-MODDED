package alternativa.tanks.models.statistics.team
{
   ...
   public class StatisticsTeamModel extends StatisticsTeamModelBase implements IStatisticsTeamModelBase, ObjectLoadListener, ObjectLoadPostListener, ObjectUnloadListener, IClientUserInfo, BattleEventListener, IStatisticRound
   {
      ...
      private var rewardApplied:Boolean;
      ...
      {
         var _loc1_:ClientUserStat = this.getLocalUserStat();
         if(_loc1_ != null)
         {
      ...
      public function roundFinish(param1:Boolean, param2:Boolean, param3:int, param4:Vector.<UserReward>) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:ClientUserStat = null;
         this.statisticsTable.hide();
         ...
         _loc6_ = this.getLocalReward(param4);
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = this.getLocalUserStat();
            if(_loc8_ != null)
            {
               _loc7_ = _loc8_.reward;
            }
         }
         if(_loc7_ != 0)
         {
            this.applyLocalReward(_loc7_);
         }
         if(param2)
         {
            _loc5_ = param1 && Boolean(challengeInfoService.isInTime());
            this.statisticsTable.showTeam(param1,this.getLocalUserStatId(),this.redClientUsersStat,this.blueClientUsersStat,true,serverHaltService.isServerHalt ? -1 : param3,this.localUserTeam,_loc5_);
         }
         if(param2 && _loc7_ != 0 && Boolean(lobbyLayoutService.isWindowOpenOverBattle()) && !battleInfoService.isSpectatorMode())
         {
      ...
      private function getLocalReward(param1:Vector.<UserReward>) : UserReward
      {
         var _loc2_:UserReward = null;
         if(param1 == null)
         {
            return null;
         }
         _loc2_ = StatisticsVectorUtils.getRewardById(userPropertiesService.userId,param1);
         if(_loc2_ == null)
         {
            _loc2_ = StatisticsVectorUtils.getRewardById(userPropertiesService.userName,param1);
         }
         if(_loc2_ == null)
         {
            _loc2_ = this.getRewardByLocalStat(param1);
         }
         if(_loc2_ == null && param1.length == 1)
         {
            _loc2_ = param1[0];
         }
         return _loc2_;
      ...
      private function getRewardByLocalStat(param1:Vector.<UserReward>) : UserReward
      {
         var _loc2_:ClientUserStat = this.getLocalUserStat();
         var _loc3_:UserReward = null;
         if(_loc2_ != null)
         {
            _loc3_ = StatisticsVectorUtils.getRewardById(_loc2_.userId,param1);
            if(_loc3_ == null)
            {
               _loc3_ = StatisticsVectorUtils.getRewardById(_loc2_.uid,param1);
            }
         }
         return _loc3_;
      }

      private function applyLocalReward(param1:int) : void
      {
         if(!this.rewardApplied && moneyService != null && param1 != 0)
         {
            moneyService.setServerCrystals(moneyService.crystal + param1);
      ...
      private function getLocalUserPlace() : int
      {
         ...
         if(this.localUserTeam == BattleTeam.RED)
         {
            _loc1_ = StatisticsVectorUtils.getUserPosition(this.redClientUsersStat,this.getLocalUserStatId());
         }
         else if(this.localUserTeam == BattleTeam.BLUE)
         {
            _loc1_ = StatisticsVectorUtils.getUserPosition(this.blueClientUsersStat,this.getLocalUserStatId());
         }
         return _loc1_ + 1;
      }
      ...
      private function getLocalUserStatId() : String
      {
         var _loc1_:ClientUserStat = this.getLocalUserStat();
         return _loc1_ != null ? _loc1_.userId : userPropertiesService.userId;
      }

      private function getLocalUserStat() : ClientUserStat
      {
         var _loc2_:ClientUserStat = null;
         var _loc3_:ClientUserStat = null;
         var _loc1_:ClientUserStat = this.getUserStat(userPropertiesService.userId);
         if(_loc1_ == null)
         {
            _loc1_ = this.getUserStat(userPropertiesService.userName);
         }
         if(_loc1_ == null)
         {
            for each(_loc2_ in this.redClientUsersStat)
            {
               if(this.isLocalUserStat(_loc2_))
               {
                  return _loc2_;
               }
            }
            for each(_loc3_ in this.blueClientUsersStat)
            {
               if(this.isLocalUserStat(_loc3_))
               {
                  return _loc3_;
               }
            }
      ...
      private function isLocalUserStat(param1:ClientUserStat) : Boolean
      {
         return this.isSameUser(param1.userId,userPropertiesService.userId) || this.isSameUser(param1.userId,userPropertiesService.userName) || this.isSameUser(param1.uid,userPropertiesService.userId) || this.isSameUser(param1.uid,userPropertiesService.userName);
      }

      private function isSameUser(param1:String, param2:String) : Boolean
      {
         return param1 != null && param2 != null && param1.toLowerCase() == param2.toLowerCase();
      }
   }
}
