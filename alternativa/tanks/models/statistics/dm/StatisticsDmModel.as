   ...
   public class StatisticsDmModel extends StatisticsDMModelBase implements IStatisticsDMModelBase, IObjectLoadListener, IClientUserInfo, BattleEventListener, IStatisticRound
   {
      ...
      public function roundFinish(param1:Boolean, param2:Boolean, param3:int, param4:Vector.<UserReward>) : void
      {
         ...
         if(param2)
         {
            ...
            this.statisticsTable.showDm(param1,_loc5_,this.getLocalUserStatId(),this.clientUsersStat,true,param3);
            if(_loc7_ != 0 && Boolean(lobbyLayoutService.isWindowOpenOverBattle()) && !battleInfoService.isSpectatorMode())
            {
      ...
      {
         return StatisticsVectorUtils.getUserPosition(this.clientUsersStat,this.getLocalUserStatId()) + 1;
      }
      ...
      private function getLocalUserStat() : ClientUserStat
      {
         ...
         if(_loc1_ == null)
         {
            for each(_loc2_ in this.clientUsersStat)
            {
