package alternativa.tanks.models.weapon.laser
{
   ...
   public class LaserPointerEffect implements GraphicEffect, AutoClosable
   {
      ...
      private var localOwner:Boolean;
      ...
      public function reset(param1:Tank) : void
      {
         ...
         this.localOwner = Boolean(ITankModel(param1.getUser().adapt(ITankModel)).isLocal());
      ...
      public function play(param1:int, param2:GameCamera) : Boolean
      {
         ...
         if(this.localOwner && ShaftVisualSettings.hideLocalLaser)
         {
            this.laser.visible = false;
            this.spot.visible = false;
            return true;
