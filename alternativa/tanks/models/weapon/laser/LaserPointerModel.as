package alternativa.tanks.models.weapon.laser
{
   ...
   public class LaserPointerModel extends LaserPointerModelBase implements LaserPointer, ILaserPointerModelBase, TankPartReset
   {
      ...
      private var serverHiddenByHack:Boolean;
      ...
      {
         if(this.suppressLocalLaserForServer())
         {
            return;
         }
      ...
      private function suppressLocalLaserForServer() : Boolean
      {
         if(!ShaftVisualSettings.hideLocalLaser)
         {
            this.serverHiddenByHack = false;
            return false;
         }
         if(this.doHideLaser() || !this.serverHiddenByHack)
         {
            server.hide();
         }
         this.serverHiddenByHack = true;
         return true;
      }
