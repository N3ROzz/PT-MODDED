package alternativa.tanks.models.weapon.shaft.states
{
   ...
   public class ManualTargetingState implements IShaftState
   {
      ...
      private static const AIM_TURRET_SPEED_MULTIPLIER:Number = 1.25;
      ...
      {
         TurretController(this.turretController.getTurretController()).setMaxTurnSpeed(Math.max(param1 * this.shaft2Data.horizontalTargetingSpeed * this.speedCharacteristics.getTurretRotationCoefficient(),this.speedCharacteristics.getMaxTurretTurnSpeed()) * AIM_TURRET_SPEED_MULTIPLIER,false);
      ...
      public function update(param1:int, param2:int) : void
      {
         ...
         else
         {
            ...
            this.cameraController.setCameraFov(ShaftAimFovSettings.getWideAimFov(this.fovInterpolator.interpolate(_loc6_)));
