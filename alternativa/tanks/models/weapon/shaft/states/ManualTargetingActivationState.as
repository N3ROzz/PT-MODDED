package alternativa.tanks.models.weapon.shaft.states
{
   ...
   public class ManualTargetingActivationState implements IShaftState
   {
      ...
      public function enter(param1:int) : void
      {
         ...
         TurretController(this.turretController.getTurretController()).setMaxTurnSpeed(Math.max(this.shaftCC.horizontalTargetingSpeed * this.speedCharacteristics.getTurretRotationCoefficient(),this.speedCharacteristics.getMaxTurretTurnSpeed()) * AIM_TURRET_SPEED_MULTIPLIER,false);
         ...
         this.fovInterpolator.setInterval(this.camera.fov,ShaftAimFovSettings.getWideAimFov(this.targetFOV));
