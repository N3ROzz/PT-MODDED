package alternativa.tanks.models.weapon.shaft
{
   ...
   public class ShaftSFXModel extends ShaftShootSFXModelBase implements IShaftShootSFXModelBase, IShaftSFXModel, ObjectLoadPostListener, ObjectUnloadListener
   {
      ...
      {
         var _loc3_:TextureAnimation = GraphicsUtils.getTextureAnimation(materialRegistry,getFilteredBitmap(param1.data,["shaft","shaft_m2","explosion","explosionTexture","muzzleFlash","muzzleFlashTexture","shot","default"]),param1.frameWidth,param1.frameHeight,param1.numFrames);
         _loc3_.fps = param1.fps;
      ...
      {
         var _loc2_:TextureMaterial = materialRegistry.getMaterial(getFilteredBitmap(param1,["shaft","shaft_m2","trail","trailTexture","shot","default"]));
