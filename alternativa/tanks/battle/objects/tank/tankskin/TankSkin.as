package alternativa.tanks.battle.objects.tank.tankskin
{
   ...
   import juho.hacking.PaintColoring;
   ...
   public class TankSkin
   {
      ...
      private var visualMaterials:SkinMaterials;
      ...
      public function dispose() : void
      {
         ...
         if(this.visualMaterials != null)
         {
            this.releaseMaterials(this.visualMaterials);
         }
         this.normalMaterials = null;
         this.deadMaterials = null;
         this.visualMaterials = null;
         this.hullMesh = null;
      ...
      {
         var _loc1_:SkinMaterials = this.visualMaterials != null ? this.visualMaterials : this.normalMaterials;
         this.hullMesh.setMaterialToAllFaces(_loc1_.hullMaterial);
         this.turretSkin.setMaterials(_loc1_.turretMaterial, _loc1_.turretDynamicMaterial);
         this.setTracksMaterial(_loc1_.leftTrackMaterial,_loc1_.rightTrackMaterial);
      }
      
      public function setVisualColoring(param1:Object) : void
      {
         if(this.visualMaterials != null)
         {
            this.releaseMaterials(this.visualMaterials);
         ...
         if(param1 != null)
         {
            this.visualMaterials = this.tankSkinMaterialFactory.createSkinMaterials(this,new PaintColoring(param1));
         }
         this.setNormalState();
      }
