package alternativa.tanks.controllers.battlecreate
{
   ...
   public class CreateBattleFormController extends EventDispatcher
   {
      ...
      private function selectDefaultMap() : void
      {
         ...
         var _loc3_:CreateBattleMapParams = _loc2_ == null ? null : this.getMapParams(_loc2_.mapId,_loc2_.themeName);
      ...
      public function onCreateBattle() : void
      {
         ...
         if(this.isBattleParamsCorrect())
         {
            ...
            _loc1_.withoutMines = !this._view.isMinesEnabled;
            _loc1_.withoutMedkit = !this._view.isFirstAidEnabled;
            ...
            _loc1_.esportDropTiming = this._view.isPreciseTimerEnabled;
            _loc1_.reducedResistances = this._view.isWeakenedResistancesEnabled;
            _loc1_.withoutCrystals = !this._view.isCrystalBoxesEnabled;
            _loc1_.withoutGoldBoxes = !this._view.isGoldBoxesEnabled;
            _loc1_.withoutGoldSiren = !this._view.isGoldBoxSirenEnabled;
            _loc1_.withoutGoldZone = !this._view.isGoldBoxDropZoneEnabled;
            _loc1_.randomGold = this._view.isGoldBoxRandomFundEnabled;
            ...
            _loc1_.proBattle = false;
            if(!_loc1_.proBattle)
            {
               this.normalizeRegularBattleParams(_loc1_);
            }
      ...
      private function normalizeRegularBattleParams(param1:BattleCreateParameters) : void
      {
         param1.withoutUpgrades = false;
         param1.withoutDrones = false;
         param1.esportDropTiming = false;
         param1.reducedResistances = false;
         param1.randomGold = false;
         param1.dependentCooldownEnabled = false;
      }
