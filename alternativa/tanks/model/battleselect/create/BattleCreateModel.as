package alternativa.tanks.model.battleselect.create
{
   ...
   public class BattleCreateModel extends BattleCreateModelBase implements IBattleCreateModelBase, IObjectLoadListener
   {
      ...
      private var formListenersAdded:Boolean;
      ...
      private function ensureCreateFormController() : void
      {
         if(this.formListenersAdded)
         {
            return;
         }
      ...
      public function objectUnloaded() : void
      {
         ...
         this.formListenersAdded = false;
         if(this.getCreateBattleFormController() != null)
         {
