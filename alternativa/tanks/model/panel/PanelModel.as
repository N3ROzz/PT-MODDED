package alternativa.tanks.model.panel
{
   ...
   public class PanelModel extends PanelModelBase implements IPanelModelBase, ObjectLoadListener, ObjectLoadPostListener, ObjectUnloadListener
   {
      ...
      private static const HELPER_RATING:int = 3;
      ...
      private function initHelpers() : void
      {
         ...
         var _loc11_:RatingIndicatorHelper = new RatingIndicatorHelper(1,RANK_BAR_WIDTH,RATING_HELPER_OFFSET);
         ...
         helpService.registerHelper(HELPER_GROUP_KEY,HELPER_RATING,_loc11_,true);
      ...
      private function onButtonBarButtonClick(param1:MainButtonBarEvents) : void
      {
         ...
         {
            FriendsLoaderModel.requestOpenWhenLoaded();
            Network(OSGi.getInstance().getService(Network)).send(new FriendsLoadOutPacket());
         }
